...
return new class extends Migration
{
    ...
    {
        Schema::create('verifikasi_kesra', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('status', ['PENDING', 'VALID', 'TIDAK_VALID', 'PERLU_PERBAIKAN', 'DITERIMA', 'DITOLAK']);
            $table->text('catatan')->nullable();
            $table->timestamp('verified_at')->nullable();
            $table->timestamps();
        });

        Schema::table('verifikasi_kesra', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('verifikasi_kesra');
    }
};
